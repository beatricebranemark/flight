...
ost.forEach(d => {
    ...
    let ko = {
        ...
        travelTypes:[korv[0].values ?  korv[0].values.length:0,korv[1] ?  korv[1].values.length:0,korv[2] ?  korv[2].values.length:0,korv[3]?  korv[3].values.length:0],
    ...
    ko['total'] = ko.EkonomiKlass+ ko.EkonomiPremium + ko.Business +ko.Unknown;
...
var z = d3.scaleOrdinal()
    ...
    var keys = ['EkonomiKlass','EkonomiPremium', 'Business', 'FirstClass', 'Unknown']
...
return <React.Fragment><svg id="chart" width="400" height="600"></svg>
    </React.Fragment>
